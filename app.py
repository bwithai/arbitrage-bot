...
ROUTES = ["pancakeswap_v2", "dodo_dex"]
COINS = {
...
SOLID_COIN = ["usdt", "usdc"]  # usdt address
VARIABLE_COIN = [
    'bel',
    'axs',
    'ach',
...
def init_contract():
    """Initialize Contract"""
    with open("abi/RouterV2Abi.json") as f:
        v2_abi = json.load(f)
...
# 2023-10-10 11:58:50     153532.7306207377987448 positive        USDT            BEL             pancakeswap_v2  dodo_dex        BEL/USDT        962.0868074315972       USDT/BEL       1536.3273062073781